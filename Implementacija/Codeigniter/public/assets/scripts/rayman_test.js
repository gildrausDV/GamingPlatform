...
function send_data() {
    ...
    $.ajax({
        ...
        //dataType: 'json',
        data: {arguments: [t, points, level - 2, date.getFullYear(), date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds()]},
...
function init() {
    ...
    interval = setInterval(function() {
        ...
        else if(pls && loaded && started && !ended) animate();
